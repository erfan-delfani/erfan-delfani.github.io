...
<div class="cv-line">
  <span class="cv-content">
    <strong>Research Engineer</strong>, Linköping University, Linköping, Sweden
    <span class="cv-desc">Research on semantics-aware communication for energy-efficient integrated terrestrial and non-terrestrial networks under the EU <a href="https://ether-project.eu/" target="_blank" rel="noopener noreferrer">ETHER</a> project, hosted by Prof. Nikolaos Pappas.</span>
  </span>
...
<div class="cv-line">
  <span class="cv-content">
    ...
    <span class="cv-desc">Research on network management for efficient resource allocation in telecommunication networks under the EU MSCA <a href="https://elixirion-mc.eu/" target="_blank" rel="noopener noreferrer">ELIXIRION</a> project, hosted by Dr. Lechosław Tomaszewski.</span>
  </span>
...
<div class="cv-line">
  <span class="cv-content">
    ...
    <span class="cv-desc">Research on data management to enhance the energy efficiency of wearable devices in the Internet of Medical Things (IoMT) under the EU MSCA <a href="https://elixirion-mc.eu/" target="_blank" rel="noopener noreferrer">ELIXIRION</a> project, hosted by Dr. Andreas Schramm and Mr. Fahmi Mousa.</span>
  </span>
